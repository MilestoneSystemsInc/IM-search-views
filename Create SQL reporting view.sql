...
-- Description: Create or alter a view to having the headings defined in the system for the Incident Management.
-- Important - This is designed to be run once and then update or correct a view called reporting in the Surveillance_IM database. For Production systems recommend waiting for the IM API to be available. 
